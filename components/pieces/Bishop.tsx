...
export function WhiteBishop({ className = "" }: PieceProps) {
  return (
    <svg
      viewBox="0 0 45 45"
      className={className}
      fill="currentColor"
      aria-label="White Bishop"
    >
      <g>
        <path
        ...
        />
        <path
          d="M17.5 26h10M15 30h15M22.5 14.5v12"
          stroke="currentColor"
          strokeWidth="1"
          strokeLinecap="round"
          fill="none"
...
export function BlackBishop({ className = "" }: PieceProps) {
  return (
    <svg
      viewBox="0 0 45 45"
      className={className}
    ...
    >
      <g>
        ...
        <path
          ...
          strokeLinejoin="round"
        />
        <circle cx="22.5" cy="20" r="3" fill="currentColor" opacity="0.3" />
      </g>
    </svg>
  );
}
